  ...
  return (
    <Box sx={{ bgcolor: 'background.default' }}>
      ...
      >
        ...
        {/* Content */}
        <Box sx={{ p: { xs: 3, sm: 4 }, pt: { xs: 4, sm: 5 }, position: 'relative', zIndex: 1 }}>
          {/* App Icon */}
          <Box
            sx={{
              width: { xs: 60, sm: 80 },
          ...
          >
            Experience the full power of Abacus Learning on your mobile device with our feature-rich app
          </Typography>
