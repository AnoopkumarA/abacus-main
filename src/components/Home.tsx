...
import { Brain, Trophy, Clock, Target, ArrowRight, Users, Star, Zap, X, Download } from 'lucide-react';
    ...
    <Box sx={{ bgcolor: 'background.default' }}>
      ...
      >
        ...
        <Box sx={{ p: 4, pt: 3 }}>
          ...
          >
            Get access to all features offline and enjoy a better mobile experience
          </Typography>

          <Box sx={{ mb: 3 }}>
            <Typography variant="body1" sx={{ mb: 1, display: 'flex', alignItems: 'center', gap: 1 }}>
              <Star size={16} color="#1976d2" /> Offline access
            </Typography>
            <Typography variant="body1" sx={{ mb: 1, display: 'flex', alignItems: 'center', gap: 1 }}>
              <Star size={16} color="#1976d2" /> Better performance
            </Typography>
            <Typography variant="body1" sx={{ mb: 1, display: 'flex', alignItems: 'center', gap: 1 }}>
              <Star size={16} color="#1976d2" /> Push notifications
            </Typography>
          </Box>
